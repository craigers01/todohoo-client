...
var Index = {
  ...
  newSearchVenues : function() {
    Index.map.setQueryBounds();
    Index.performSearchVenues(Index.map.getBounds());
  },

 performSearchVenues : function(mapBounds) {
   console.log("X");
    var markersArray = venueMarkers.searchMarkers(Index.map.map,
  ...
  $(function() {
    ...
    $("input[name=SearchVenues]").click(Index.newSearchVenues);
